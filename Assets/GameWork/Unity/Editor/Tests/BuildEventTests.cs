...
namespace GameWork.Unity.Editor.Tests
{
    ...
    public static class BuildEventTests
    {
        ...
        [TestCase(BuildTarget.WebGL, new string[] { "webgl_pre", "webgl_post" })]
        ...
        [BuildEvent(EventType.Pre, 0, BuildTarget.WebGL)]
        private static void PreBuildEventWebGL()
        {
            _eventTargets.Add("webgl_pre");
        }

        [BuildEvent(EventType.Post, 0, BuildTarget.WebGL)]
        private static void PostBuildEventWebGL()
        {
            _eventTargets.Add("webgl_post");
        }
        #endregion
    }
}